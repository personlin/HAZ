...
C       attenflag = 2 Spectra
     ...
     3        coefcountRjb, idist, iProb, nper, iper, icf, dcpp_GMPE_Flag
      real Theta_site, cfcoefRRup(MAX_Atten,14), cfcoefRjb(MAX_Atten,11),
...
C     Check for Common Functional Form with Rrup Distance (16000<jcalc<17000) selected and if so read in coefficients.
            if (jcalc1 .gt. 16000 .and. jcalc1 .lt. 17000) then
                coefcountrrup = jcalc1 - 16000
                read (13,*) (cfcoefrrup(coefcountRrup,jj),jj=1,14)
            endif
C     Check for Common Functional Form with RJB Distance (17000<jcalc<18000) selected and if so read in coefficients.
            if (jcalc1 .gt. 17000 .and. jcalc1 .lt. 18000) then
                coefcountrrup = jcalc1 - 17000
                read (13,*) (cfcoefrrup(coefcountRrup,jj),jj=1,12)
            endif
...
c     Write input parameters to output file.
            ...
            write (67, '(1x,a40,a104,a91)') ' Period(s)   Mag     Rrup       Rjb     ',
